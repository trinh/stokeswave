...
%
% Feb 2016: for website logo

function plotme_websitelogo
...
%     delete(handles.surf.edge_left{1})
    ...
    set(gca, 'Visible', 'off');
    axis vis3d
    set(gca, 'DataAspectRatio', [1 1 1.8]);
    view([-70, 15]);
    ...
    function plotplane
        ...
        % Back plane
        fill3([dom(1) dom(2) dom(2) dom(1)], dom(4)*[1 1 1 1], [(minz - zwidth) (minz - zwidth) (minz) (minz)], basecol,'LineWidth', outwidth);
        % Top plane
