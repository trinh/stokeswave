%*****************************************
%SAM: please confirm this file for deletion as singularity location
%detection should be implemented in qt_bdint_path_solve.m
%
%PHIL: Do you mind if I modify your latest version so it outputs singloc as
%well (I use this in get_sing_loc.m). Using this file for the moment
%*****************************************

function [pathdat, singloc] = qt_bdint_path_solve_sam_singloc(s, solseries, sing_start)
