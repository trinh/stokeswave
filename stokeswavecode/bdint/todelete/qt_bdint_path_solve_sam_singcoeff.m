% *****************************************
% SAM: please confirm this file for deletion as singularity coef
% detection should be implemented in qt_bdint_path_solve.m
% *****************************************

% function [pathdat, singcoeff] = qt_bdint_path_solve_sam_singcoeff(s, solseries, sing_start, singloc)
...
% 
% % For the singularity coefficient integral
% integralval = 0;
% 
...
%     
%     if j >= sing_start
%     % Calculate the integral for the singlarity coefficient
...
% end
% 
% singcoeff = (1/(4*pi*1i))*integralval;
% 
