function path = get_path_phil(name)
    ...
    switch name
        ...
        case 'dualmesh.A'
            xmax = 1.9;
            base = [0.4 + pm, 0.4 + 1i, -0.1 + 1i, -0.1 + pm, -xmax + pm];
            path.up = [base, 999];
        ...
        case 'dualmesh.AA_AA_AA_'
            ...
            f = 0.1 + pm;
            newf = genellipse(f(1), 0, a_ellipse, [0, pi], 30);
            f = [f, newf];
            ...
            % Bottom
            newf = genellipse(real(f(end)), 0, a_ellipse, [0, pi], 30);
            f = [f, newf];
            f(end) = real(f(end)) - pm;
            f = [f, NaN, real(f(end)) + pm];
            ...
            path.f = path.down(1:end-1);
        case 'dualmesh.AA_AA_AA_B_ep0.5'
            % fB = 0.54 - 0.39i
            % fC = 0.86 - 0.62i
            % fD = 1.14 - 0.8i
            xmax = 1.5;
            ...
            base = [base, -phi0 - 0.6i, 0.7 - 0.6i, 0.7 - pm, -xmax - pm];
            path.down = [base, 999];
            path.up = [base, NaN, -xmax + pm, -xmax + 0.05i, -xmax + pm, 999];
            path.f = path.down(1:end-1);
        case 'dualmesh.AA_AA_AA_C_ep0.5'
            % fB = 0.54 - 0.39i
            % fC = 0.86 - 0.62i
            % fD = 1.14 - 0.8i
            xmax = 1.5;
            ...
            tour = [phi0 + pm, phi0 + psi0, -phi0 + psi0, -phi0 + pm, NaN, ...
                -phi0 - pm, -phi0 - psi0, phi0 - psi0, phi0 - pm];
            base = [tour, NaN, tour, NaN, tour(1:7)];
            %             base = [base, 0.7 - phi0, 0.65 - 1i, 0.95 - 1i, 0.95 - pm, -xmax - pm];
            base = [base, phi0 - psi0, phi0 - pm, 0.75 - pm, 0.75 - 1i, 0.95 - 1i, 0.95 - pm, -xmax - pm];
            path.down = [base, 999];
            path.up = [base, NaN, -xmax + pm, -xmax + 0.05i, -xmax + pm, 999];
            path.f = path.down(1:end-1);
            
            % Epsilon = 0.1 meshes
        case 'dualmesh.AA_ep0.1'
            xmax = 2.5;
            psi0 = 0.4i;
            phi0 = 0.1;
        ...
        case 'dualmesh.AA_Bep0.1'
            ...
            tour = [phi0 + pm, phi0 + psi0, -phi0 + psi0, -phi0 + pm, NaN, ...
                    -phi0 - pm, -phi0 - psi0, phi0 - psi0, phi0 - pm];
            base = [tour(1:end-2), -phi0 - 0.7i, 1 - 0.7i, 1 - pm, -xmax - pm];
            path.down = [base, 999];
            path.up = [base, NaN, -xmax + pm, -xmax + 0.05i, -xmax + pm, 999];
            path.f = path.down(1:end-1);
        case 'dualmesh.AA_AA_ep0.1'
            xmax = 2.5;
            phi0 = 0.1;
            psi0 = 0.4i;
